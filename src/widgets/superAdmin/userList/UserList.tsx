...
import {useBanUserMutation, useDeleteUserMutation, useGetUsersMutation} from '@/entities/users/api/usersApi'
...
export const UserList: FC = () => {
    ...
    const [defaultValueBan, setDefaultValueBan] = useState('Bad beh')
